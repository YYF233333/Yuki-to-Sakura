...
define config.name = _("yuki_to_sakura")
...
define build.name = "yuki_to_sakura"
...
define config.end_game_transition = MultipleTransition(
    [
        False, 
        Dissolve(3),
        Solid("#000"),
...
define config.save_directory = "yukitosakura-1611314220"
